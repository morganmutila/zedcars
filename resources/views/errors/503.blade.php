    ...
    <main
        ...
        <div class="row justify-content-center">
            <div class="col-sm-11 col-md-9 col-lg-7 col-xl-6">
                ...
                <h1 class="h2 text-center pt-4 pt-md-5 mt-1 mt-sm-2 mt-md-0 mb-4">Service Unavailable</h1>
                <p class="lead text-center fs-4">This site is currently undergoing scheduled maintenance. Please try back
                    soon!</p>
            </div>
        </div>
    </main>
