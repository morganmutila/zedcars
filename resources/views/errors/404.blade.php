        ...
        <div class="row justify-content-center">
            <div class="col-sm-11 col-md-9 col-lg-7 col-xl-6">
                <div class="ratio mx-auto" style="max-width: 196px; --fn-aspect-ratio: calc(126 / 196 * 100%)">
                    <img src="{{ asset('assets/img/errors/cones.png') }}" alt="Traffic cones">
                </div>
                <h1 class="h2 text-center pt-4 pt-md-5 mt-1 mt-sm-2 mt-md-0 mb-4">404 Page Not Found</h1>
                <p class="lead text-center fs-4">Sorry, we can't find that page</p>
            </div>
        </div>
    </main>
