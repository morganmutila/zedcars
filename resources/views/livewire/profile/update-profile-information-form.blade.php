    ...
    <form wire:submit="updateProfileInformation" class="{{ $errors->any() ? 'is-invalid' : '' }}">
        ...
        @if (auth()->user() instanceof \Illuminate\Contracts\Auth\MustVerifyEmail && !auth()->user()->hasVerifiedEmail())
            <div class="row g-4 mb-3">
                <div class="alert d-sm-flex alert-warning pb-4 pt-sm-4" role="alert">
                    ...
                    <div class="ps-sm-3 pe-sm-4">
                        ...
                        <div class="d-flex align-items-start gap-3">
                            <button wire:click.prevent="sendVerification" class="btn btn-warning mb-2 mb-sm-0">
                                {{ __('Verify Email.') }}
                            </button>
                            @if (session('status') === 'verification-link-sent')
                                <p class="alert-success mb-0">
        ...
        <div class="row row-cols-1 row-cols-sm-2 g-4 mb-4">
            ...
            <div class="col position-relative">
                ...
                <input type="tel" class="form-control form-control-lg" id="phone"
                    ...
                    value="(212) 555-7890" placeholder="(___) ___-____">
