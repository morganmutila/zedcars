...
<div wire:ignore.self class="d-flex flex-column bg-white mx-md-4 justify-items-center justify-content-center">
    ...
    <form class=" {{ $errors->any() ? ' is-invalid ' : '' }}" wire:submit.prevent="login">
        ...
        <div class="d-flex align-items-center justify-content-between mb-4">
            ...
            <div class="nav">
                @if (Route::has('password.request'))
                    <a class="btn-link animate-underline p-0" href="{{ route('password.request') }}" wire:navigate>
        ...
        <div class="nav d-flex align-items-center justify-content-center fs-sm my-3">
            Don't have an account? <button type="button" class="btn btn-link ps-1 py-0" data-bs-toggle="modal" data-bs-target="#registerModal">
                Sign up
            </button>
        </div>
