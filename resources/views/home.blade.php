...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title>Home | {{ env('app.name') }} </title>
    <meta name="description" content="{{ env('app.name') }} - Directory &amp; Listings Bootstrap HTML Template">
    <meta name="keywords"
                        ...
                        <li class="nav-item dropdown py-lg-2 me-lg-n1 me-xl-0">
                            ...
                            <ul class="dropdown-menu">
                                <li class="hover-effect-opacity px-2 mx-n2">
                                    <a class="dropdown-item d-block mb-0" href="home-real-estate.html">
                                        <span class="fw-medium">Real Estate</span>
                                        <span class="d-block fs-xs text-body-secondary">Property listings
                                            directory</span>
                                        <div class="d-none d-lg-block hover-effect-target position-absolute top-0 start-100 bg-body border border-light-subtle rounded rounded-start-0 transition-none invisible opacity-0 pt-2 px-2 ms-n2"
                                            ...
                                            <img class="position-relative z-2 d-none-dark"
                                                src="assets/img/mega-menu/real-estate-light.jpg" alt="Real Estate Demo">
                                            <img class="position-relative z-2 d-none d-block-dark"
                                                src="assets/img/mega-menu/real-estate-dark.jpg"
                                ...
                                <li class="hover-effect-opacity px-2 mx-n2">
                                    <a class="dropdown-item d-block mb-0" href="home-cars.html">
                                        ...
                                        <div class="d-none d-lg-block hover-effect-target position-absolute top-0 start-100 bg-body border border-light-subtle rounded rounded-start-0 transition-none invisible opacity-0 pt-2 px-2 ms-n2"
                                            style="width: 212px; height: calc(100% + 2px); margin-top: -1px">
                                            <img class="position-relative z-2 d-none-dark"
                                                src="assets/img/mega-menu/cars-light.jpg" alt="Cars Demo">
                                            <img class="position-relative z-2 d-none d-block-dark"
                                                src="assets/img/mega-menu/cars-dark.jpg" alt="Cars Demo">
                                            <span
                                                class="position-absolute top-0 start-0 w-100 h-100 rounded rounded-start-0 d-none-dark"
                                                style="box-shadow: .875rem .5rem 2rem -.5rem #676f7b; opacity: .1"></span>
                                            <span
                                ...
                                <li class="hover-effect-opacity px-2 mx-n2">
                                    <a class="dropdown-item d-block mb-0" href="home-contractors.html">
                                        ...
                                        <span class="d-block fs-xs text-body-secondary">Professional services
                                            directory</span>
                                        <div class="d-none d-lg-block hover-effect-target position-absolute top-0 start-100 bg-body border border-light-subtle rounded rounded-start-0 transition-none invisible opacity-0 pt-2 px-2 ms-n2"
                                            style="width: 212px; height: calc(100% + 2px); margin-top: -1px">
                                            <img class="position-relative z-2 d-none-dark"
                                                src="assets/img/mega-menu/contractors-light.jpg"
                                                alt="Contractors Demo">
                                            <img class="position-relative z-2 d-none d-block-dark"
                                                src="assets/img/mega-menu/contractors-dark.jpg"
                                                alt="Contractors Demo">
                                            <span
                                                class="position-absolute top-0 start-0 w-100 h-100 rounded rounded-start-0 d-none-dark"
                                                style="box-shadow: .875rem .5rem 2rem -.5rem #676f7b; opacity: .1"></span>
                                ...
                                <li class="hover-effect-opacity px-2 mx-n2">
                                    <a class="dropdown-item d-block mb-0" href="home-doctors.html">
                                        <span class="fw-medium">Doctors</span>
                                        <span class="d-block fs-xs text-body-secondary">Medical professionals
                                            listings</span>
                                        <div class="d-none d-lg-block hover-effect-target position-absolute top-0 start-100 bg-body border border-light-subtle rounded rounded-start-0 transition-none invisible opacity-0 pt-2 px-2 ms-n2"
                                            style="width: 212px; height: calc(100% + 2px); margin-top: -1px">
                                            <img class="position-relative z-2 d-none-dark"
                                                src="assets/img/mega-menu/doctors-light.jpg" alt="Doctors Demo">
                                            <img class="position-relative z-2 d-none d-block-dark"
                                                src="assets/img/mega-menu/doctors-dark.jpg" alt="Doctors Demo">
                                            <span
                                                class="position-absolute top-0 start-0 w-100 h-100 rounded rounded-start-0 d-none-dark"
                                                style="box-shadow: .875rem .5rem 2rem -.5rem #676f7b; opacity: .1"></span>
                                            <span
                                ...
                                <li class="hover-effect-opacity px-2 mx-n2">
                                    <a class="dropdown-item d-block mb-0" href="home-events.html">
                                        <span class="fw-medium">Events</span>
                                        <span class="d-block fs-xs text-body-secondary">Upcoming events listings</span>
                                        <div class="d-none d-lg-block hover-effect-target position-absolute top-0 start-100 bg-body border border-light-subtle rounded rounded-start-0 transition-none invisible opacity-0 pt-2 px-2 ms-n2"
                                            style="width: 212px; height: calc(100% + 2px); margin-top: -1px">
                                            <img class="position-relative z-2 d-none-dark"
                                                src="assets/img/mega-menu/events-light.jpg" alt="Events Demo">
                                            <img class="position-relative z-2 d-none d-block-dark"
                                                src="assets/img/mega-menu/events-dark.jpg" alt="Events Demo">
                                            <span
                                                class="position-absolute top-0 start-0 w-100 h-100 rounded rounded-start-0 d-none-dark"
                                                style="box-shadow: .875rem .5rem 2rem -.5rem #676f7b; opacity: .1"></span>
                                            <span
                                ...
                                <li class="hover-effect-opacity px-2 mx-n2">
                                    <a class="dropdown-item d-block mb-0" href="home-city-guide.html">
                                        <span class="fw-medium">City Guide</span>
                                        <span class="d-block fs-xs text-body-secondary">Local places directory</span>
                                        <div class="d-none d-lg-block hover-effect-target position-absolute top-0 start-100 bg-body border border-light-subtle rounded rounded-start-0 transition-none invisible opacity-0 pt-2 px-2 ms-n2"
                                            style="width: 212px; height: calc(100% + 2px); margin-top: -1px">
                                            <img class="position-relative z-2 d-none-dark"
                                                src="assets/img/mega-menu/city-guide-light.jpg" alt="City Guide Demo">
                                            <img class="position-relative z-2 d-none d-block-dark"
        ...
        <section class="position-relative bg-info overflow-hidden py-5">
            <div class="container position-relative z-2 pb-2 py-sm-3 py-md-4 py-lg-5 my-lg-3 my-xl-4 my-xxl-5">
                <div class="row align-items-center pt-lg-2 pb-lg-3 pb-xl-4 pb-xxl-5">
                    ...
                    <!-- Heading -->
                    <div
                        class="col-lg-4 order-lg-2 text-center text-lg-start pb-2 pb-sm-3 pb-md-0 mb-4 mb-md-5 mb-lg-0">
                        ...
                        <div class="bg-white rounded p-4 mb-4 me-lg-4 me-xxl-0"
                            ...
                            <form class="p-sm-2" data-bs-theme="light">
                                <div class="d-flex justify-content-center justify-content-md-start gap-2 gap-sm-3 mb-4"
                                    data-bs-theme="dark">
                                    <input type="radio" class="btn-check" name="car-search" id="all-cars"
                                        checked="">
                              ...
                              &quot;containerInner&quot;: [&quot;form-select&quot;, &quot;rounded-start-0&quot;]
                                        ...
                                        <div class="input-group flex-nowrap" data-bs-theme="light">
                                            <div class="position-relative w-100">
                                                ...
                                                <input type="text"
                                                    class="form-control form-icon-start rounded-end-0"
                                                    placeholder="Price from"
                                                    data-input-format="{&quot;numeral&quot;: true}"
                                                    data-bs-theme="light">
                                            </div>
                                            <div class="position-relative w-100">
                                                <i
                                                    class="fi-dollar-sign position-absolute top-50 start-0 translate-middle-y text-body ms-3"></i>
                                                <input type="text"
                                                    class="form-control form-icon-start rounded-start-0"
            ...
            <div
                ...
                <div class="d-flex justify-content-xl-end position-relative bg-info mb-n5 mb-xxl-4"
                    style="width: 2039px">
                        ...
                        <article class="card w-100 hover-effect-scale bg-body-tertiary border-0">
                            <div class="card-body text-center px-3">
                                <div class="ratio hover-effect-target"
                                    style="--fn-aspect-ratio: calc(80 / 164 * 100%)">
                    ...
                    <div class="swiper-slide">
                        <article class="card w-100 hover-effect-scale bg-body-tertiary border-0">
                            <div class="card-body text-center px-3">
                                ...
                                <h3 class="h6 pt-3 mb-1">
                                    <a class="hover-effect-underline stretched-link"
                                        href="listings-grid-cars.html">Family MPV</a>
                                </h3>
                                ...
                                <div class="card-body pb-3 pb-md-4">
                                    <div class="d-flex align-items-center justify-content-between mb-2">
                                        ...
                                        <div class="d-flex gap-2 position-relative z-2">
                                            ...
                                            <button type="button"
                                                ...
                                                data-bs-toggle="tooltip" data-bs-custom-class="tooltip-sm"
                                                title="Notify" aria-label="Notify">
                                    ...
                                    <h3 class="h5 mb-2">
                                        <a class="hover-effect-underline stretched-link me-1"
                                            href="single-entry-cars.html">Maserati Granturismo</a>
                        ...
                        <div class="row g-0">
                            ...
                            <div class="col-sm-7 py-md-2">
                                <div class="card-body pb-3 pb-md-4">
                                    ...
                                    <h3 class="h5 mb-2">
                                        <a class="hover-effect-underline stretched-link me-1"
                                            href="single-entry-cars.html">Volvo XC90 Sport 4WD</a>
        ...
        <section class="container pt-2 pt-sm-3 pt-md-4 pt-lg-5 pb-5 my-xxl-3">
            ...
            <div class="swiper pt-1 pt-sm-2 py-lg-2 py-xl-3"
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide nav">
                        <a class="nav-link p-0" href="listings-grid-cars.html" data-bs-toggle="tooltip"
                            title="Toyota" aria-label="Toyota">
                            <svg xmlns="http://www.w3.org/2000/svg" width="141" viewBox="0 0 141 64"
                                fill="currentColor">
                                <path
                    ...
                    <div class="swiper-slide nav">
                        <a class="nav-link p-0" href="listings-grid-cars.html" data-bs-toggle="tooltip"
                            title="Citroen" aria-label="Citroen">
                            <svg xmlns="http://www.w3.org/2000/svg" width="141" viewBox="0 0 141 64"
                                fill="currentColor">
                                <path
        ...
        <section class="container pt-2 pt-sm-3 pt-md-4 pt-lg-5 pb-5 my-xxl-3">
            ...
            <div class="swiper"
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <article class="hover-effect-scale position-relative text-center">
                            ...
                            <h3 class="h6 pt-3 mb-0">
                                <a class="hover-effect-underline stretched-link"
                                    href="listings-grid-cars.html">Electric cars</a>
                            </h3>
                        </article>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <article class="hover-effect-scale position-relative text-center">
                            <div class="bg-body-tertiary rounded-circle overflow-hidden mx-auto"
                                style="width: 132px">
                                <div class="ratio ratio-1x1 hover-effect-target">
                    ...
                    <div class="swiper-slide">
                        <article class="hover-effect-scale position-relative text-center">
                            ...
                            <h3 class="h6 pt-3 mb-0">
                                <a class="hover-effect-underline stretched-link"
                                    href="listings-grid-cars.html">Off-road cars</a>
                            </h3>
                        </article>
                    </div>
                    ...
                    <div class="swiper-slide">
                        <article class="hover-effect-scale position-relative text-center">
                            ...
                            <h3 class="h6 pt-3 mb-0">
                                <a class="hover-effect-underline stretched-link"
                                    href="listings-grid-cars.html">Family cars</a>
                            </h3>
                        </article>
                    </div>
                </div>
                    ...
                    <div class="swiper-slide">
                        <article class="position-relative hover-effect-scale">
                            <div class="position-relative rounded overflow-hidden">
                                ...
                                <div class="ratio hover-effect-target"
                                    style="--fn-aspect-ratio: calc(272 / 416 * 100%)">
                            ...
                            <h3 class="h5 pt-3 pt-sm-4 mt-1 mt-sm-0 mb-0">
                                <a class="hover-effect-underline stretched-link" href="blog-single-v2.html">Electric
                                    Mercedes sedan car reportedly debuting in 2025</a>
                            </h3>
                        </article>
                    </div>
                        ...
                        <article class="position-relative hover-effect-scale">
                            ...
                            <h3 class="h5 pt-3 pt-sm-4 mt-1 mt-sm-0 mb-0">
                                <a class="hover-effect-underline stretched-link" href="blog-single-v2.html">Budget
                                    vs Premium tyres: which are better value this year?</a>
                            </h3>
                        </article>
                    </div>
                        ...
                        <article class="position-relative hover-effect-scale">
                            ...
                            <h3 class="h5 pt-3 pt-sm-4 mt-1 mt-sm-0 mb-0">
                                <a class="hover-effect-underline stretched-link" href="blog-single-v2.html">Tesla
                                    fixes common recall with over-the-air update</a>
                            </h3>
                        </article>
                    </div>
                </div>
    ...
    <footer class="footer bg-body border-top" data-bs-theme="dark">
        <div class="container pt-sm-2 pt-md-3 pt-lg-4">
            ...
            <div class="accordion row pb-4 py-sm-5" id="footerLinks">
                    ...
                    <div class="accordion-item border-0">
                        <h6 class="accordion-header" id="buySellHeading">
                            ...
                            <button type="button" class="accordion-button collapsed py-3 d-sm-none"
                                data-bs-toggle="collapse" data-bs-target="#buySell" aria-expanded="false"
                                aria-controls="buySell">Buying &amp; selling</button>
                        </h6>
                        <div class="accordion-collapse collapse d-sm-block" id="buySell"
                            aria-labelledby="buySellHeading" data-bs-parent="#footerLinks">
                ...
                <div class="col-md-5 col-lg-4 col-xl-3 pt-4 pt-sm-5 pt-md-0 mt-3 mt-sm-0">
                    ...
                    <div class="d-flex gap-3">
                        ...
                        <a class="btn btn-market btn-lg w-100" href="#!"
            ...
            <div
                ...
                <p class="text-body-secondary fs-sm text-center mb-0 order-sm-1">Copyright © {{ date('Y') }}
                    Zedcars. All rights reserved.</p>
            </div>
        </div>
    </footer>
